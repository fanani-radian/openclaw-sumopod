# 🎥 YouTube Tutorials - OpenClaw Sumopod

Kumpulan video tutorial tentang OpenClaw dari komunitas Sumopod.

---

## 📺 Kodingworks Tutorial Series
...
**📝 Topics:**
- Membuat Telegram Bot (@BotFather)
...
**📝 Topics:**
- Multi-agent setup (Radit, Raka, Rama, Rafi)
...
2. Follow Video #2 (Setup)
3. Complete Video #3 (Telegram)

**For Advanced Users:**
4. Video #4 (Advanced Config)
5. Video #5 (Tips & Use Cases)
...
- Disarankan tonton berurutan untuk pemula
- Kode dan config bisa ditemukan di repo ini
- Ada pertanyaan? Tanya di [Discord](../../issues/new)

---

## 🤝 Kontribusi Video

Punya video tutorial OpenClaw? [Submit di sini](../../issues/new?template=resource.md)
...
*Videos by: [Kodingworks](https://www.youtube.com/@kodingworks)*
